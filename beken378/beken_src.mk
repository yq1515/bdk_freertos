...
INCLUDES += -I$(BEKEN_DIR)/beken378/release
INCLUDES += -I$(BEKEN_DIR)/beken378/demo
...
INCLUDES += -I$(BEKEN_DIR)/beken378/ip/umac/src/mfp
...
INCLUDES += -I$(BEKEN_DIR)/beken378/app/video_work
INCLUDES += -I$(BEKEN_DIR)/beken378/app/net_work
...
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/i2c
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/jpeg
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/security
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/irda
INCLUDES += -I$(BEKEN_DIR)/beken378/func/include
INCLUDES += -I$(BEKEN_DIR)/beken378/func/ble_wifi_exchange
...
INCLUDES += -I$(BEKEN_DIR)/beken378/func/camera_intf
INCLUDES += -I$(BEKEN_DIR)/beken378/func/video_transfer
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/hostapd
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/bk_patch
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/src/utils
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/src/ap
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/src/common
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/src/drivers
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/src
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/wpa_supplicant
INCLUDES += -I$(BEKEN_DIR)/beken378/func/$(WPA_VERSION)/bk_patch
...
INCLUDES += -I$(BEKEN_DIR)/beken378/func/saradc_intf
INCLUDES += -I$(BEKEN_DIR)/beken378/func/rwnx_intf
INCLUDES += -I$(BEKEN_DIR)/beken378/func/joint_up
INCLUDES += -I$(BEKEN_DIR)/beken378/func/base64
INCLUDES += -I$(BEKEN_DIR)/beken378/func/easy_flash
INCLUDES += -I$(BEKEN_DIR)/beken378/func/easy_flash/inc
INCLUDES += -I$(BEKEN_DIR)/beken378/func/easy_flash/port
INCLUDES += -I$(BEKEN_DIR)/beken378/func/rf_use
INCLUDES += -I$(BEKEN_DIR)/beken378/func/usb
INCLUDES += -I$(BEKEN_DIR)/beken378/func/sensor
INCLUDES += -I$(BEKEN_DIR)/beken378/os/include
INCLUDES += -I$(BEKEN_DIR)/beken378/os/FreeRTOSv9.0.0
INCLUDES += -I$(BEKEN_DIR)/beken378/func/utf8
INCLUDES += -I$(BEKEN_DIR)/beken378/app/http

ifeq ($(CFG_BK_AWARE),1)
INCLUDES += -I$(BEKEN_DIR)/beken378/func/bk_aware
endif

ifeq ($(CFG_USE_SDCARD_HOST),1)
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/msc
INCLUDES += -I$(BEKEN_DIR)/beken378/func/fatfs
endif

# For BK7251
ifeq ($(CFG_SOC_NAME), 3)
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/audio
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/sdcard
endif

# For WPA3
ifeq ($(CFG_WPA3),1)
INCLUDES += -I$(BEKEN_DIR)/beken378/func/wolfssl
endif
...
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/ble_5_x_rw/ble_pub/profiles/sdp/api
...
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/drivers/
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/drivers/comm
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/drivers/hid
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/drivers/msd
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/drivers/compl
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/drivers/hub
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/drivers/trans
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/example/msd
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/hid
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/lib
INCLUDES += -I$(BEKEN_DIR)/beken378/driver/usb/src/msc
...
INCLUDES += -I$(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/include
INCLUDES += -I$(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/include/mbedtls
INCLUDES += -I$(BEKEN_DIR)/beken378/func/mbedtls/mbedtls-port/inc
INCLUDES += -I$(BEKEN_DIR)/beken378/func/mbedtls/mbedtls_ui/
endif


ifeq ($(ATSVR_CFG),1)
INCLUDES += -I$(BEKEN_DIR)/beken378/func/at_server/
INCLUDES += -I$(BEKEN_DIR)/beken378/func/at_server/_at_server
...
#application layer
SRC_C += $(BEKEN_DIR)/beken378/app/app.c
...
SRC_C += $(BEKEN_DIR)/beken378/app/video_work/video_transfer_tcp.c
SRC_C += $(BEKEN_DIR)/beken378/app/video_work/video_transfer_udp.c
SRC_C += $(BEKEN_DIR)/beken378/app/video_work/video_buffer.c
SRC_C += $(BEKEN_DIR)/beken378/app/net_work/video_demo_main.c
SRC_C += $(BEKEN_DIR)/beken378/app/net_work/video_demo_station.c
...
SRC_C += $(BEKEN_DIR)/beken378/driver/fft/fft.c
...
SRC_C += $(BEKEN_DIR)/beken378/driver/i2s/i2s.c
...
SRC_C += $(BEKEN_DIR)/beken378/driver/pwm/pwm_bk7231n.c
SRC_C += $(BEKEN_DIR)/beken378/driver/pwm/mcu_ps_timer.c
SRC_C += $(BEKEN_DIR)/beken378/driver/pwm/bk_timer.c
SRC_C += $(BEKEN_DIR)/beken378/driver/pwm/pwm_mutex.c
SRC_C += $(BEKEN_DIR)/beken378/driver/qspi/qspi.c
...
SRC_C += $(BEKEN_DIR)/beken378/driver/uart/uart.c
SRC_C += $(BEKEN_DIR)/beken378/driver/uart/printf.c
SRC_C += $(BEKEN_DIR)/beken378/driver/wdt/wdt.c
SRC_C += $(BEKEN_DIR)/beken378/driver/calendar/calendar.c
SRC_C += $(BEKEN_DIR)/beken378/driver/security/security.c
SRC_C += $(BEKEN_DIR)/beken378/driver/security/hal_aes.c
SRC_C += $(BEKEN_DIR)/beken378/driver/security/hal_sha.c
SRC_C += $(BEKEN_DIR)/beken378/driver/jpeg/jpeg_encoder.c
SRC_C += $(BEKEN_DIR)/beken378/driver/i2c/i2c1.c
SRC_C += $(BEKEN_DIR)/beken378/driver/i2c/i2c2.c

ifeq ($(CFG_SDIO),1)
SRC_C += $(BEKEN_DIR)/beken378/driver/sdio/sdio.c
SRC_C += $(BEKEN_DIR)/beken378/driver/sdio/sdma.c
SRC_C += $(BEKEN_DIR)/beken378/driver/sdio/sutil.c
endif

#function layer
SRC_C += $(BEKEN_DIR)/beken378/func/func.c
SRC_C += $(BEKEN_DIR)/beken378/func/usb_plug/usb_plug.c
SRC_C += $(BEKEN_DIR)/beken378/func/security/security_func.c
...
SRC_WPA_C += $(BEKEN_DIR)/beken378/func/hostapd_intf/hostapd_intf.c
ifeq ($(CFG_USE_SDCARD_HOST),1)
SRC_C += $(BEKEN_DIR)/beken378/func/fatfs/cc936.c
SRC_C += $(BEKEN_DIR)/beken378/func/fatfs/ccsbcs.c
SRC_C += $(BEKEN_DIR)/beken378/func/fatfs/disk_io.c
SRC_C += $(BEKEN_DIR)/beken378/func/fatfs/driver_udisk.c
SRC_C += $(BEKEN_DIR)/beken378/func/fatfs/ff.c
SRC_C += $(BEKEN_DIR)/beken378/func/fatfs/playmode.c
endif

ifeq ($(CFG_SDIO),1)
SRC_C += $(BEKEN_DIR)/beken378/func/sdio_intf/sdio_intf.c
endif
...
SRC_C += $(BEKEN_DIR)/beken378/func/lwip_intf/lwip-2.0.2/src/apps/ping/ping.c
...
SRC_C += $(BEKEN_DIR)/beken378/func/misc/pseudo_random.c
...
SRC_C += $(BEKEN_DIR)/beken378/func/power_save/ap_idle.c
SRC_C += $(BEKEN_DIR)/beken378/func/saradc_intf/saradc_intf.c
...
SRC_C += $(BEKEN_DIR)/beken378/func/wlan_ui/bk_peripheral_test.c
# utf8
SRC_C += $(BEKEN_DIR)/beken378/func/utf8/conv_utf8.c

# video / jpeg
SRC_C += $(BEKEN_DIR)/beken378/func/camera_intf/camera_intf.c
SRC_C += $(BEKEN_DIR)/beken378/func/video_transfer/video_transfer.c

# For WPA3: wolfssl
ifeq ($(CFG_WPA3),1)
SRC_C += $(BEKEN_DIR)/beken378/func/wolfssl/wolfcrypt/src/wolfmath.c
SRC_C += $(BEKEN_DIR)/beken378/func/wolfssl/wolfcrypt/src/memory.c
SRC_C += $(BEKEN_DIR)/beken378/func/wolfssl/wolfcrypt/src/tfm.c
SRC_C += $(BEKEN_DIR)/beken378/func/wolfssl/wolfcrypt/src/ecc.c

# wpa_supplicant 2.9 needs random generator
SRC_C += $(BEKEN_DIR)/beken378/func/wolfssl/wolfcrypt/src/random.c
SRC_C += $(BEKEN_DIR)/beken378/func/wolfssl/wolfcrypt/src/sha256.c
endif

# For BK7251
ifeq ($(CFG_SOC_NAME), 3)
SRC_C += $(BEKEN_DIR)/beken378/driver/audio/audio.c
SRC_C += $(BEKEN_DIR)/beken378/driver/audio/audio_adc.c
SRC_C += $(BEKEN_DIR)/beken378/driver/audio/audio_dac.c
SRC_C += $(BEKEN_DIR)/beken378/driver/audio/ring_buffer.c
SRC_C += $(BEKEN_DIR)/beken378/driver/audio/ring_buffer_dma_read.c
SRC_C += $(BEKEN_DIR)/beken378/driver/audio/ring_buffer_dma_write.c

SRC_C += $(BEKEN_DIR)/beken378/func/audio/audio_intf.c

SRC_C += $(BEKEN_DIR)/beken378/driver/sdcard/sdcard.c
SRC_C += $(BEKEN_DIR)/beken378/driver/sdcard/sdio_driver.c
SRC_C += $(BEKEN_DIR)/beken378/driver/spi/spi.c
SRC_C += $(BEKEN_DIR)/beken378/driver/spi/spi_master.c
SRC_C += $(BEKEN_DIR)/beken378/driver/spi/spi_slave.c
SRC_C += $(BEKEN_DIR)/beken378/func/sd_music/sdcard_test.c
endif
...
SRC_C += $(BEKEN_DIR)/beken378/func/base64/base_64.c
SRC_C += $(BEKEN_DIR)/beken378/func/airkiss/bk_airkiss.c
...
SRC_C += $(BEKEN_DIR)/beken378/func/easy_flash/src/ef_env_wl.c
SRC_C += $(BEKEN_DIR)/beken378/func/easy_flash/src/ef_iap.c
SRC_C += $(BEKEN_DIR)/beken378/func/easy_flash/src/ef_log.c
SRC_C += $(BEKEN_DIR)/beken378/func/easy_flash/src/ef_utils.c
...
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls-port/src/timing_alt.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls-port/src/tls_certificate.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls-port/src/tls_client.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls-port/src/tls_hardware.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls-port/src/tls_mem.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls-port/src/tls_net.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/aes.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/aesni.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/arc4.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/asn1parse.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/asn1write.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/base64.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/bignum.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/blowfish.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/camellia.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ccm.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/certs.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/cipher.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/cipher_wrap.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/cmac.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ctr_drbg.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/debug.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/des.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/dhm.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ecdh.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ecdsa.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ecjpake.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ecp.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ecp_curves.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/entropy.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/entropy_poll.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/error.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/gcm.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/havege.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/hmac_drbg.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/md.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/md_wrap.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/md2.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/md4.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/md5.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/memory_buffer_alloc.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/net_sockets.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/oid.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/padlock.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pem.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pk.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pk_wrap.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pkcs5.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pkcs11.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pkcs12.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pkparse.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/pkwrite.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/platform.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ripemd160.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/rsa.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/sha1.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/sha256.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/sha512.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ssl_cache.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ssl_ciphersuites.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ssl_cli.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ssl_cookie.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ssl_srv.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ssl_ticket.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/ssl_tls.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/threading.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/timing.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/version.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/version_features.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/x509.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/x509_create.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/x509_crl.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/x509_crt.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/x509_csr.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/x509write_crt.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/x509write_csr.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls/library/xtea.c
SRC_C += $(BEKEN_DIR)/beken378/func/mbedtls/mbedtls_ui/sl_tls.c
endif

ifeq ($(CFG_SUPPORT_BLE),1)
ifeq ($(CFG_BLE_VERSION),$(BLE_VERSION_4_2))
#ble pub
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/ble.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/app/src/app_ble.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/app/src/app_comm.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/app/src/app_sdp.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/app/src/app_sec.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/app/src/app_task.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/driver/ble_icu/ble_icu.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/driver/uart/ble_uart.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/modules/arch/ble_arch_main.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/modules/common/RomCallFlash.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/modules/dbg/dbg.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/modules/dbg/dbg_mwsgen.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/modules/dbg/dbg_swdiag.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/modules/dbg/dbg_task.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/plactform/modules/rf/src/ble_rf_xvr.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/profiles/comm/src/comm.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/profiles/comm/src/comm_task.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/profiles/prf/src/prf.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/profiles/prf/src/prf_utils.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/profiles/sdp/src/sdp_service.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/profiles/sdp/src/sdp_service_task.c
#ble mesh pub
ifeq ($(CFG_SUPPORT_BLE_MESH),1)
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/mesh_api/mesh_api.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/mesh_api/mesh_api_msg.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/mesh_api/mesh_param_int.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/mesh_api/mm_api.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/mesh_api/mm_api_msg.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/mesh_api/m_api.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/mesh_api/m_api_msg.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/common/mm_route.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/common/mm_tb.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/common/mm_tb_bind.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/common/mm_tb_replay.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/common/mm_tb_state.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_bat.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_dtt.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_loc.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_lvl.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_oo.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_plvl.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_poo.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/gens/mm_gens_prop.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lightc/mm_lightc.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lightc/mm_lightc_ctl.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lightc/mm_lightc_hsl.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lightc/mm_lightc_ln.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lightc/mm_lightc_xyl.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lights/mm_lights.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lights/mm_lights_ctl.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lights/mm_lights_hsl.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/lights/mm_lights_ln.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/Scenes/m_fnd_Scenes.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/transition_time/m_fnd_generic_transition_time.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/vendor/mm_vendors.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/beken_ble_sdk/mesh/src/models/vendor/mm_vendor_midea.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/app/src/app_mesh.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/app/src/app_mm_msg.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/gernel_api/mesh_general_api.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble/modules/mesh_model/ali/app_light_ali_server.c
endif
...
SRC_C += $(BEKEN_DIR)/beken378/driver/ble_5_x_rw/ble_pub/app/src/app_ble_init.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble_5_x_rw/ble_pub/app/src/app_sdp.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble_5_x_rw/ble_pub/profiles/sdp/src/sdp_common.c
SRC_C += $(BEKEN_DIR)/beken378/driver/ble_5_x_rw/ble_pub/profiles/sdp/src/sdp_comm_task.c
...
ifeq ($(ATSVR_CFG),1)
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/_at_server_port/atsvr_core.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/_at_server_port/atsvr_port.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/atsvr_cmd/atsvr_cmd.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/atsvr_cmd/atsvr_wlan.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/atsvr_cmd/atsvr_misc.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/_at_server/_at_server.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/_at_server/_at_server_port.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/at_server_func/_atsvr_func.c
SRC_C += $(BEKEN_DIR)/beken378/func/at_server/at_server.c
endif

ifeq ($(CFG_USB),1)
SRC_C += $(BEKEN_DIR)/beken378/driver/usb/usb.c
SRC_C += $(BEKEN_DIR)/beken378/func/usb/fusb.c
endif
...
SRC_IP_C =
-include $(BEKEN_DIR)/beken378/ip/ip_lib_src.mk

SRC_BLE_C =
ifeq ($(CFG_SUPPORT_BLE),1)
ifeq ($(CFG_BLE_VERSION),$(BLE_VERSION_4_2))
-include $(BEKEN_DIR)/beken378/driver/ble/ble_lib_src.mk
endif
ifeq ($(CFG_BLE_VERSION),$(BLE_VERSION_5_x))
-include $(BEKEN_DIR)/beken378/driver/ble_5_x_rw/ble_lib_src.mk
endif
endif

SRC_USB_C =
ifeq ($(CFG_USB),1)
-include $(BEKEN_DIR)/beken378/driver/usb/usb_lib_src.mk
endif

SRC_SENSOR_C =
ifeq ($(CFG_WIFI_SENSOR),1)
-include $(BEKEN_DIR)/beken378/func/sensor/sensor_lib_src.mk
endif

SRC_CAL_C =
-include $(BEKEN_DIR)/beken378/func/bk7011_cal/cal_lib_src.mk

SRC_SUPPLICANT_C =
-include $(BEKEN_DIR)/beken378/func/wpa_supplicant_2_9/supplicant_lib_src.mk

SRC_UART_DEBUG_C =
-include $(BEKEN_DIR)/beken378/func/uart_debug/uart_debug_lib_src.mk

SRC_RF_TEST_C =
-include $(BEKEN_DIR)/beken378/func/rf_test/rf_test_lib_src.mk

SRC_RF_USE_C =
-include $(BEKEN_DIR)/beken378/func/rf_use/rf_use_lib_src.mk
